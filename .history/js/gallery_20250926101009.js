...
function updateModalContent(image) {
  if (galleryElements.modalImage) {
    galleryElements.modalImage.src = image.image; // 修复：使用image.image而不是image.src
    galleryElements.modalImage.alt = image.title; // 修复：使用image.title作为alt
  }
