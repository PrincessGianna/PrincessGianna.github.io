...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function startHandwritingAnimation(pageNumber = currentPage) {
    ...
    // 获取当前页面的手写行
    const currentPageElement = document.querySelector(`.love-page[data-page="${pageNumber}"]`);
  ...
  function flipToPage(targetPage) {
    ...
    const currentPageElement = document.querySelector(`.love-page[data-page="${currentPage}"]`);
    const targetPageElement = document.querySelector(`.love-page[data-page="${targetPage}"]`);
