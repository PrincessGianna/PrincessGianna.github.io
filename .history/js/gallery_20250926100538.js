...
function cacheGalleryElements() {
  ...
  // 窗口全局调试函数
  window.debugGalleryDescription = function() {
    console.log("=== GALLERY DESCRIPTION DEBUG ===");
    console.log("Modal element:", galleryElements.modal);
    console.log("Description element:", galleryElements.modalDescription);
    
    if (galleryElements.modalDescription) {
      console.log("Description content:", galleryElements.modalDescription.textContent);
      console.log("Description innerHTML:", galleryElements.modalDescription.innerHTML);
      const computed = window.getComputedStyle(galleryElements.modalDescription);
      ...
      console.log("Element rect:", galleryElements.modalDescription.getBoundingClientRect());
    }
