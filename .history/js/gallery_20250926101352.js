...
function updateModalContent(image) {
  console.log("updateModalContent called with:", image);
  ...
  if (galleryElements.modalDescription) {
    console.log("Setting description to:", image.description);
    galleryElements.modalDescription.textContent = image.description;
  } else {
    console.log("galleryElements.modalDescription not found");
  }
